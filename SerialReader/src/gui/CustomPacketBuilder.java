...
public class CustomPacketBuilder extends JPanel {
	...
	private SerialPacketTester _serial;
	public CustomPacketBuilder(SerialPacketTester serialPacketTester) {
		_serial = serialPacketTester;
		...
		_message.addKeyListener(new KeyListener(){
			...
			public void keyPressed(KeyEvent arg0) {
				if(arg0.getKeyCode()==KeyEvent.VK_ENTER){
					...
					_serial.send(data, _destinationPort.getText());
				}
			}
			@Override
			public void keyReleased(KeyEvent arg0) {}
